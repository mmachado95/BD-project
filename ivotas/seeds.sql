...
VALUES
  ('CG 2', 'Conselho Geral 2', '2017-11-20 22:00:00', '2017-12-22 10:15:00', 1),
  ('CG 3', 'Conselho Geral 3', '2017-12-20 22:00:00', '2017-12-21 10:15:00', 1);

INSERT INTO Eleicao(nome, descricao, inicio, fim, tipo, total_votos, votos_brancos, votos_nulos)
VALUES
  ('CG 1', 'Conselho Geral', '2017-11-20 22:00:00', '2017-11-13 10:15:00', 1, 6, 1, 1);

INSERT INTO Eleicao(nome, unidade_organica_id, descricao, inicio, fim, tipo)
VALUES
  ('NEI', 3, 'Nucleo de Estudantes de Informatica', '2017-11-20 22:00:00', '2017-12-22 10:15:00', 2),
  ('NEG', 6, 'Nucleo de Estudantes de Gestao', '2017-12-20 22:00:00', '2017-12-21 10:15:00', 2);

INSERT INTO Eleicao(nome, unidade_organica_id, descricao, inicio, fim, tipo, total_votos, votos_brancos, votos_nulos)
VALUES
  ('NEM', 4, 'Nucleo de Estudantes de Mecanica', '2017-11-20 22:00:00', '2017-11-13 10:15:00', 2, 4, 2, 1);

INSERT INTO Lista(eleicao_id, nome, numero_votos)
VALUES
  (6, 'LISTA NEM A', 1),
  (6, 'LISTA NEM B', 0),
  (3, 'LISTA CG1 ALUNOS C', 0),
  (3, 'LISTA CG1 ALUNOS D', 2),
  (3, 'LISTA CG1 DOCENTES A', 0),
  (3, 'LISTA CG1 DOCENTES B', 1),
  (3, 'LISTA CG1 FUNCIONARIOS X', 0),
  (3, 'LISTA CG1 FUNCIONARIOS Z', 1);
...
VALUES
  (3, 2, '2017-11-20 22:00:03'),
  (4, 2, '2017-11-20 22:00:04'),
  (3, 2, '2017-11-20 22:00:03'),
  (4, 2, '2017-11-20 22:00:04'),
  (10, 3, '2017-11-20 22:00:04'),
  (14, 3, '2017-11-20 22:00:04'),
  (5, 3, '2017-11-20 22:00:04'),
  (6, 3, '2017-11-20 22:00:04'),
  (12, 3, '2017-11-20 22:00:04'),
  (13, 3, '2017-11-20 22:00:04');
